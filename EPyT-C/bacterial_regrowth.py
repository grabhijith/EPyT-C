# EPyT_C - Developed by EPyT_C - Developed by Abhijith & Avi 
# -----------------------------------------------------------
...
class reaction():
    ...
    def pipe_reaction(num1, num2, num3, num4, num5, num6, arr1, arr2):
        ...
        delta_chlorine_rdoc_reac_pipe = reaction.first_order_reaction(KbNC, arr2[0][num3][num2], num1)
        delta_chlorine_bdoc_reac_pipe = reaction.first_order_reaction(KbSC, arr2[0][num3][num2], num1)
        ...
        delta_bacteria_regrowth_pipe = reaction.first_order_reaction(u, arr2[3][num3][num2], num1)
        delta_bacteria_death_pipe = reaction.first_order_reaction(Kd, arr2[3][num3][num2], num1)
        delta_bacteria_lysis_pipe = reaction.first_order_reaction(klys, arr2[4][num3][num2], num1)
    ...
    def tank_reaction(num1, num2, num3, num4, num5, arr1, arr2, arr3):
        ...
        delta_chlorine_rdoc_reac_tank = (num4/ num5) * reaction.first_order_reaction(KbNC, tank_chlorine_conc, num1)
        delta_chlorine_bdoc_reac_tank = (num4/ num5) * reaction.first_order_reaction(KbSC, tank_chlorine_conc, num1)
        ...
        delta_bacteria_regrowth_tank = (num4/ num5) * reaction.first_order_reaction(u, tank_flb_conc, num1)
        delta_bacteria_death_tank = (num4/ num5) * reaction.first_order_reaction(Kd, tank_flb_conc, num1)
        delta_bacteria_lysis_tank = (num4/ num5) * reaction.first_order_reaction(klys, tank_fdb_conc, num1)
